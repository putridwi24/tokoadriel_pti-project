                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="text-sm-start text-gray-80">Menambahkan <br>Produk</div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-lg-start font-weight-bold text-success text-uppercase mb-1">
                                    Kelola Data</div>
                                <div class="text-sm-start text-gray-80">Menambahkan <br> Kelola Data</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-lg-start font-weight-bold text-warning text-uppercase mb-1">
                                    Kedaluwarsa</div>
                                <div class="text-sm-start text-gray-80">Menampilkan Produk kedaluwarsa</div>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="text-sm-start text-gray-80">Menampilkan Produk akan habis</div>
                            </div>
                            <div class="col-auto">
